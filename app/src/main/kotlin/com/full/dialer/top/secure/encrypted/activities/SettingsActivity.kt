...
import com.full.dialer.top.secure.encrypted.dialogs.ManageVisibleTabsDialog
...
class SettingsActivity : SimpleActivity() {
    ...
    private fun setupManageBlockedNumbers() {
        ...
        if (settings_use_english_holder.isGone() && settings_manage_blocked_numbers_holder.isGone()) {
