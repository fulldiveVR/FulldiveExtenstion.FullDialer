...
fun Context.isAProApp() = packageName.startsWith("com.full.dialer.top") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.full.dialer") && !packageName.startsWith("com.full.dialer")) {
        true
    } else if ((packageName.startsWith("com.full.dialer") || packageName.startsWith("com.full.dialer")) && isQPlus()) {
